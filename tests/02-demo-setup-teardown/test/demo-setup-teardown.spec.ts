...
test.describe('@demo_setup_teardown', () => {
  test('Test case 1: Add a product to cart', async({page}) => {
    ...
    console.log( await page.locator(".hero-primary").allTextContents());
  })

  test('Test case 2: Get all product names', async({page}) => {
    await page.goto("https://rahulshettyacademy.com/client");
